...
- (void)viewWillAppear:(BOOL)animated { //viewWillAppear is 1) first time you see view or 2) when you leave the page and come back to it later
...
#pragma mark - Reachability for Network Connection checks
