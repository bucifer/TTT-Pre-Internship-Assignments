...
- (void) initTerrysLocationManagerCustomObject{
    ...
    id x = [[TerrysLocationManager alloc]init];
    self.terrysLocationManager = x;
    [x release];
    
    /*
    self.terrysLocationManager = [[TerrysLocationManager alloc]init];
     originall you had this, this doesn't work.
     When you allocate on the right side, TerrysLocationManager gets owned by ViewController.
     But on the second step, terrysLocationManager property now owns it. Making its retain count 2.
     When you release it the property later, ViewController's ownership is still 1 so it doesn't get released properly.
    */
    
    TerrysLocationManager *t = self.terrysLocationManager;
    t.myVC = self;
}
...
- (void) initTerrysNetworkManagerCustomObject {
    ...
    id x = [[TerrysNetworkManager alloc]init];
    self.terrysNetworkManager = x;
    [x release];
    
    TerrysNetworkManager *t =  self.terrysNetworkManager;
    t.myVC = self;
